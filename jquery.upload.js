jQuery.extend({
    ...
    ajaxFileUpload: function(s) {
        ...
        var uploadCallback = function(isTimeout) {			
            ...
            try {
				if (io.contentWindow) {
					 if (io.contentWindow.document.body.textContent) {
					    xml.responseText = io.contentWindow.document.body.textContent;
					 }


					 if (io.contentWindow.document.body.outerContent) {
					    xml.responseText = io.contentWindow.document.body.outerContent;
					 }
